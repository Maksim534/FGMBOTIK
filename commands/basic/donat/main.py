...
CONFIG = {
    ...
    "limit_list": {  # "купить лимит" (лимит, цена)
        1: (20_000_000_000, 100),
        2: (1_000_000_000_000, 1000),
        3: (40_000_000_000_000, 3000),
        4: (100_000_000_000_000, 6500),
    },
...
🚧 Лимит:
 - 20.000.000.000 | 100 B-Coin
🔝 Покупка: Купить лимит 1

- 1.000.000.000.000 | 1000 B-Coin
🔝 Покупка: Купить лимит 2

- 40.000.000.000.000 | 3000 B-Coin
🔝 Покупка: Купить лимит 3

- 100.000.000.000.000 | 6500 B-Coin
...
- Увеличен лимит передачи другим игрокам до 1.000.000.000$ в сутки
...
- Увеличен лимит передачи другим игрокам до 5.000.000.000$ в сутки
- Увеличена максимальная энергия до 50
- Увеличено количество открываемых кейсов до 40

3️⃣ Platinum VIP:
- Увеличен лимит передачи другим игрокам до 9.500.000.000$ в сутки
...
4️⃣ Администратор:
- Выдача денег в сутки - 1.000.000.000
...
- Красивая отметка в профиле
- Увеличен лимит передачи другим игрокам до 30.000.000.000$ в сутки
...
async def my_status(message: types.Message, user: BFGuser):
    privileges = {
        ...
        1: "🏆 Статус: Standart VIP\n🏦 Процент вклада: 8%\n💸 Лимит передачи: 1.000.000.000$/сутки",
        2: "🏆 Статус: Gold VIP\n🏦 Процент вклада: 10%\n💸 Лимит передачи: 5.000.000.000$/сутки",
        3: "🏆 Статус: Platinum VIP\n🏦 Процент вклада: 12%\n💸 Лимит передачи: 9.500.000.000$/сутки",
        4: "🏆 Статус: Администратор\n🏦 Процент вклада: 15%\n💸 Лимит передачи: 30.000.000.000$/сутки"
    }
